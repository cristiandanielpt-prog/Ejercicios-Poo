...
public class Profesor extends Empleado{
    ...
    protected ArrayList<Asignatura> listaDeAsignatura;
    protected ArrayList<Proyecto> listaDeProyectos;

    public Profesor() {
    }

    public Profesor(String especialidad,String id, String nombre, String apellido, Fecha fechaIngreso, String cargo, String StringSalarioBase) {
        super(id, nombre, apellido, fechaIngreso, cargo, StringSalarioBase);
        this.especialidad = especialidad;
        this.listaDeAsignatura = new ArrayList<Asignatura>();
